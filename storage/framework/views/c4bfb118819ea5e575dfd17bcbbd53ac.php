                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_name" required value="<?php echo e(old('product_name')); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_sku">SKU (Gudang) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="product_sku" required value="<?php echo e(old('product_sku')); ?>" placeholder="Kode SKU untuk gudang">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_gtin" value="<?php echo e(old('product_gtin')); ?>" placeholder="Kode GTIN/Barcode produk">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_quantity" required value="<?php echo e(old('product_quantity')); ?>" min="1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Alert Quantity <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="product_stock_alert" required value="<?php echo e(old('product_stock_alert', 0)); ?>" min="0" max="100">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="product_order_tax" value="<?php echo e(old('product_order_tax')); ?>" min="1">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
