                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="product_name" name="product_name" required value="<?php echo e($product->product_name); ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_sku">SKU (Gudang) <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="product_sku" name="product_sku" required value="<?php echo e($product->product_sku ?? ''); ?>" placeholder="Kode SKU untuk gudang">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="product_gtin" name="product_gtin" value="<?php echo e($product->product_gtin ?? ''); ?>" placeholder="Kode GTIN/Barcode produk">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="category_id" id="category_id" required>
                                            <?php $__currentLoopData = \Modules\Product\Entities\Category::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($category->id == $product->category->id ? 'selected' : ''); ?> value="<?php echo e($category->id); ?>"><?php echo e($category->category_name); ?></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_barcode_symbology" id="product_barcode_symbology" required>
                                            ...
                                            <option <?php echo e($product->product_barcode_symbology == 'UPCE' ? 'selected' : ''); ?> value="UPCE">UPC-E</option>
                                            <option <?php echo e($product->product_barcode_symbology == 'EAN13' ? 'selected' : ''); ?> value="EAN13">EAN-13</option>
                                            <option <?php echo e($product->product_barcode_symbology == 'EAN8' ? 'selected' : ''); ?> value="EAN8">EAN-8</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="product_cost" type="text" class="form-control" min="0" name="product_cost" required value="<?php echo e($product->product_cost); ?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_price">Price <span class="text-danger">*</span></label>
                                        <input id="product_price" type="text" class="form-control" min="0" name="product_price" required value="<?php echo e($product->product_price); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="product_quantity" name="product_quantity" required value="<?php echo e($product->product_quantity); ?>" min="1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="product_stock_alert">Alert Quantity <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" id="product_stock_alert" name="product_stock_alert" required value="<?php echo e($product->product_stock_alert); ?>" min="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="product_order_tax" name="product_order_tax" value="<?php echo e($product->product_order_tax); ?>" min="0" max="100" step="0.01">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_tax_type" id="product_tax_type">
                                            ...
                                            <option <?php echo e($product->product_tax_type == 1 ? 'selected' : ''); ?>  value="1">Exclusive</option>
                                            <option <?php echo e($product->product_tax_type == 2 ? 'selected' : ''); ?> value="2">Inclusive</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="product_unit" id="product_unit" required>
                                            ...
                                            <?php $__currentLoopData = \Modules\Setting\Entities\Unit::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php echo e($product->product_unit == $unit->short_name ? 'selected' : ''); ?> value="<?php echo e($unit->short_name); ?>"><?php echo e($unit->name . ' | ' . $unit->short_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="row mb-3">
                                    <?php $__empty_1 = true; $__currentLoopData = $product->getMedia('images'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="col-md-2 mb-2">
                                            <div class="card">
                                                <img src="<?php echo e($media->getUrl()); ?>" alt="Product Image" class="card-img-top" style="height: 100px; object-fit: cover;">
                                                <div class="card-body p-2">
                                                    <form action="<?php echo e(route('products.media.delete', [$product->id, $media->id])); ?>" method="POST" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                ...
                                <small class="form-text text-muted">You can select up to 3 images. Current: <?php echo e($product->getMedia('images')->count()); ?>/3</small>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project warnet\Nameless\Modules/Product\Resources/views/products/edit.blade.php ENDPATH**/ ?>