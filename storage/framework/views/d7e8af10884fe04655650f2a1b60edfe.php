        ...
        <div class="row mt-2">
            <div class="col-12">
                <div class="alert alert-light p-2 mb-0">
                    <small>
                        <strong>Keyboard Shortcut:</strong> Press <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>S</kbd> to open scanner
                    </small>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH D:\project warnet\Nameless\resources\views/includes/scanner-help.blade.php ENDPATH**/ ?>