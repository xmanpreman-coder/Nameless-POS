        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('scanner.settings.update')); ?>" method="POST" id="scannerSettingsForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select name="scanner_type" id="scanner_type" class="form-control" required>
                                        ...
                                        <option <?php echo e($settings->scanner_type == 'external' ? 'selected' : ''); ?> value="external">
                        ...
                        <div id="external-settings" class="scanner-settings" style="<?php echo e($settings->scanner_type !== 'external' ? 'display: none;' : ''); ?>">
                            ...
                            <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" id="external-server-url" 
                                                           value="<?php echo e(url('/api/scanner/scan')); ?>" readonly>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mt-3">
                                        <a href="<?php echo e(route('scanner.settings')); ?>" class="btn btn-info btn-block">
...
function generateExternalQRCode() {
    const setupData = {
        ...
        serverUrl: '<?php echo e(url('/api/scanner/scan')); ?>',
        method: 'POST',
