...
return new class extends Migration
{
    public function up()
    {
        Schema::create('purchase_return_details_new', function (Blueprint $table) {
        ...
        $rows = DB::select('SELECT * FROM purchase_return_details');
        foreach ($rows as $r) {
            $sku = null;
            ...
            DB::table('purchase_return_details_new')->insert([
                'id' => $r->id,
        ...
        DB::statement('ALTER TABLE purchase_return_details_new RENAME TO purchase_return_details');
    }

    public function down()
    {
        if (Schema::hasTable('purchase_return_details_old')) {
            Schema::dropIfExists('purchase_return_details');
            DB::statement('ALTER TABLE purchase_return_details_old RENAME TO purchase_return_details');
        }
    }
};
