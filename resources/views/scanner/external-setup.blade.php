...
@section('title', 'External Scanner Setup')
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="alert alert-info">
                                        ...
                                        <br>
                                        <a href="{{ route('scanner.barcode-to-pc-guide') }}" class="btn btn-info btn-sm mt-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-sm">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <code id="server-url">{{ url('/api/scanner/scan') }}</code>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <ul>
                                            <li><code>{{ url('/api/scanner/barcode') }}</code> - Alternative endpoint</li>
                                            <li><code>{{ url('/api/scanner/receive') }}</code> - Generic receiver</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td><code id="current-ip">{{ request()->getHost() }}</code></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Port:</strong></td>
                                            <td><code>{{ request()->getPort() ?: '80' }}</code></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Protocol:</strong></td>
                                            <td><code>HTTP{{ request()->isSecure() ? 'S' : '' }}</code></td>
                                        </tr>
                                        <tr>
    ...
    if (data.success) {
        ...
        console.log('Product not found');
                    ...
                    <div class="mt-4 text-center">
                        ...
                        <a href="{{ route('scanner.settings') }}" class="btn btn-primary">
...
document.getElementById('download-config').addEventListener('click', function() {
    const config = {
        endpoints: {
            scan: "{{ url('/api/scanner/scan') }}",
            batch: "{{ url('/api/scanner/batch-scan') }}",
            config: "{{ url('/api/scanner/config') }}",
            status: "{{ url('/api/scanner/status') }}"
        },
        server: {
