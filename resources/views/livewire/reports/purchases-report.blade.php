    ...
    <script>
        ...
        function downloadPDF() {
            ...
            @if($this->purchase_status)
                params.append('purchase_status', '{{ $this->purchase_status }}');
            @endif
            ...
            var pdfWindow = window.open('{{ route("purchases-report.index") }}?' + params.toString(), '_blank');
        }
        ...
        function downloadExcel() {
            ...
            window.location.href = '{{ route("purchases-report.export-csv") }}?' + params.toString();
        }
    </script>
</div>
