                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_sku" required value="{{ $product->product_sku ?? $product->product_code ?? '' }}" placeholder="Kode SKU untuk gudang">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_gtin" value="{{ $product->product_gtin ?? '' }}" placeholder="Kode GTIN/Barcode produk">
                                    </div>
                                </div>
                            </div>
