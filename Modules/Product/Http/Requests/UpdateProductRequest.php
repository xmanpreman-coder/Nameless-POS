...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'product_sku' => ['required', 'string', 'max:255', 'unique:products,product_sku,' . $this->product->id],
            'product_gtin' => ['nullable', 'string', 'max:255', 'unique:products,product_gtin,' . $this->product->id],
