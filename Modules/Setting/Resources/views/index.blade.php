                    ...
                    <div class="card-body">
                        <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="site_logo">Site Logo (Sidebar)</label>
                                        <input type="file" class="form-control-file" name="site_logo" accept="image/*">
                                        @if($settings->site_logo)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $settings->site_logo) }}" alt="Current Logo" style="max-width: 200px; max-height: 80px;">
                                                <p class="text-muted small mt-1">Current Logo</p>
                                            </div>
                                        @else
                                            <p class="text-muted small mt-1">No logo uploaded. Using default.</p>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control-file" name="login_logo" accept="image/*">
                                        @if($settings->login_logo)
                                            <div class="mt-2">
                                                <img src="{{ asset('storage/' . $settings->login_logo) }}" alt="Current Login Logo" style="max-width: 200px; max-height: 80px;">
                                                <p class="text-muted small mt-1">Current Login Logo</p>
                                            </div>
                                        @else
                                            <p class="text-muted small mt-1">No logo uploaded. Using default.</p>
                                        @endif
