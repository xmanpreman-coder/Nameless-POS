                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <img style="width: 100px;height: 100px;" class="d-block mx-auto img-thumbnail img-fluid rounded-circle mb-2" src="{{ $user->avatar_url }}" alt="Current Avatar">
                                <input type="file" name="avatar" id="avatar" class="form-control-file @error('avatar') is-invalid @enderror" accept="image/*">
                                @error('avatar')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Max size: 2MB. Allowed: JPG, PNG, GIF. Leave empty to keep current avatar.</small>
                            </div>
                        </div>
                    </div>
                </div>
