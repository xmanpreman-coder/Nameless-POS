    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Camera Scanner -->
                    <div id="camera-scanner" style="{{ $settings->scanner_type === 'camera' ? '' : 'display: none;' }}">
                    ...
                    <div class="mt-3 text-center">
                        <small class="text-muted">
                            Scanner Type: <strong>{{ ucfirst($settings->scanner_type) }}</strong> | 
                            <a href="{{ route('scanner.settings') }}">Change Settings</a>
                        </small>
                    </div>
                </div>
            </div>
...
class BarcodeScanner {
    constructor() {
        ...
        this.stream = null;
        this.currentCamera = '{{ $settings->preferred_camera }}';
        this.recentScans = [];
    ...
    showProductDetails(product, scanData = null) {
        ...
        if (product.image) {
            ...
            productImage.src = '{{ asset("images/fallback_product_image.png") }}';
            productImage.style.display = 'block';
        }
        ...
        if (this.isScanning && '{{ $settings->scan_mode }}' === 'auto') {
            this.stopScanning();
        }
    }
