                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="card bg-gradient-success text-white mb-4">
                                ...
                                <div class="card-footer bg-transparent border-0">
                                    <a href="{{ route('scanner.scan') }}" class="btn btn-light btn-sm">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card bg-gradient-info text-white mb-4">
                                ...
                                <div class="card-footer bg-transparent border-0">
                                    <a href="{{ route('scanner.settings') }}" class="btn btn-light btn-sm">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card bg-gradient-warning text-white mb-4">
                                ...
                                <div class="card-footer bg-transparent border-0">
                                    <a href="{{ route('scanner.test-camera') }}" class="btn btn-light btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-primary">
                                                    {{ ucfirst($settings->scanner_type) }}
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Scan Mode:</strong></td>
                                            <td>{{ ucfirst($settings->scan_mode) }}</td>
                                        </tr>
                                        <tr>
                                            <td><strong>Beep Sound:</strong></td>
                                            <td>
                                                <i class="bi bi-{{ $settings->beep_sound ? 'check text-success' : 'x text-danger' }}"></i>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Vibration:</strong></td>
                                            <td>
                                                <i class="bi bi-{{ $settings->vibration ? 'check text-success' : 'x text-danger' }}"></i>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td><strong>Auto Focus:</strong></td>
                                            <td>
                                                <i class="bi bi-{{ $settings->auto_focus ? 'check text-success' : 'x text-danger' }}"></i>
                                            </td>
                                        </tr>
                                    </table>

                                    <a href="{{ route('scanner.settings') }}" class="btn btn-primary btn-sm btn-block">
