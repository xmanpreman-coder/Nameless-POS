...
class Checkout extends Component
{
    ...
    public $listeners = ['productSelected', 'discountModalRefresh', 'refreshCart'];
    ...
    public function proceed() {
        // Customer tidak wajib, bisa langsung proceed
    ...
    public function refreshCart() {
        // Refresh cart data setelah transaction
        // Cart sudah di-destroy di server, jadi reset semua values
        $this->total_amount = 0;
        $this->global_discount = 0;
        $this->global_tax = 0;
        $this->shipping = 0.00;
    ...
    public function productSelected($product) {
        ...
        $cart->add([
            ...
            'options' => [
                ...
                'code'                  => $product['product_sku'] ?? $product['product_code'] ?? '',
                'gtin'                  => $product['product_gtin'] ?? null,
